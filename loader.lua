...
-- known to work on potassium, wave, awp.gg
local isLimited = ...
local environment = identifyexecutor and identifyexecutor() or ""
local source = game:HttpGet("https://raw.githubusercontent.com/ikuraxc4/test/refs/heads/main/" .. (isLimited and "sourcepf.lua" or "sourcepf.lua"))
...
elseif environment == "Nihon" and not executed then
    ...
    queue_on_teleport(game:HttpGet("https://raw.githubusercontent.com/ikuraxc4/test/refs/heads/main/hook.lua") .. "task.wait(5);" .. source)
